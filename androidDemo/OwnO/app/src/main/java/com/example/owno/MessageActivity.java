...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        myAdapter = new MessageAdapter(data,this);
        listView.setAdapter(myAdapter);
    }

    private void initData() {
        String[] content = {"你好", "你好","这里是阿猫","好的","为什么扩列呢"," 超喜欢"," 《Blood Blockade Battlefront》、《91days》","《Baccano！》"," 《DRRR!》","我们的目标是文画双修！！","擅长躺列，空间点赞，大佬舔狗","看我"};
